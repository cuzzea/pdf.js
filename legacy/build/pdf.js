...
var _base_factory = __w_pdfjs_require__(113);
...
function fetchData(url, asTypedArray) {
  if (isFetchSupported() && isValidFetchUrl(url, document.baseURI)) {
    return fetch(url).then( /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator["default"].mark(function _callee(response) {
        var data;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 13:
                ...
                data = (0, _context.t2)(_context.t3);
...
var _node_utils = __w_pdfjs_require__(116);

var _annotation_storage = __w_pdfjs_require__(117);
...
var _api = __w_pdfjs_require__(114);
...
var pdfjsVersion = '2.10.87';
var pdfjsBuild = 'c4cb71b68';
{
